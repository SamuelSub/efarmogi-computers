  ...
  return (
    <div className={styles.cardWrapper}>
      <div className={styles.card}>
        <h2 className={styles.cardHeading}>IT Support <Image src={itSupport} alt="it support icon" width={25} height={25}/></h2>
        <p className={styles.cardParagraph}>Υποστήριξη τεχνικων υπηρεσιων πληροφορικης στον χωρο εργασιας σας.</p>
      </div>
      <div className={styles.card}>
        <h2 className={styles.cardHeading}>Service Η/Υ <Image src={service} alt="copmuter technician" width={25} height={25}/></h2>
        <p className={styles.cardParagraph}>Προσφέρουμε τεχνικες υπηρεσιες για υπολογιστες, λαπτοπ, ταμπλετ και τηλεφωνα.</p>
      </div>
      <div className={styles.card}>
        <h2 className={styles.cardHeading}>Προιοντα <Image src={products} alt="tech products" width={25} height={25}/></h2>
